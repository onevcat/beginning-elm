...
var $author$project$Main$decodeStoredPosts = function (postsJson) {
	var _v0 = A2($elm$json$Json$Decode$decodeString, $author$project$Post$postsDecoder, postsJson);
	if (_v0.$ === 'Ok') {
		var posts = _v0.a;
...
var $author$project$Page$ListPosts$init = function (posts) {
	var initialCmd = ($krisajenkins$remotedata$RemoteData$isSuccess(posts) || $krisajenkins$remotedata$RemoteData$isFailure(posts)) ? $elm$core$Platform$Cmd$none : $author$project$Page$ListPosts$fetchPosts;
	return _Utils_Tuple2(
		{deleteError: $elm$core$Maybe$Nothing, posts: posts},
		initialCmd);
};
var $elm$core$Basics$negate = function (n) {
	return -n;
};
var $author$project$Post$emptyPost = {
	authorName: '',
	authorUrl: '',
	id: $author$project$Post$PostId(-1),
	title: ''
};
var $author$project$Page$NewPost$initialModel = function (navKey) {
	return {createError: $elm$core$Maybe$Nothing, navKey: navKey, post: $author$project$Post$emptyPost};
};
...
var $author$project$Main$initCurrentPage = F2(
	function (posts, _v0) {
		var model = _v0.a;
			...
			switch (_v2.$) {
				...
				case 'Post':
					...
					return _Utils_Tuple2(
						...
						A2($elm$core$Platform$Cmd$map, $author$project$Main$EditPageMsg, pageCmds));
				default:
					var _v5 = $author$project$Page$NewPost$init(model.navKey);
					var pageModel = _v5.a;
					var pageCmds = _v5.b;
					return _Utils_Tuple2(
						$author$project$Main$NewPage(pageModel),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$NewPageMsg, pageCmds));
			}
		}();
...
var $author$project$Route$matchRoute = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2($elm$url$Url$Parser$map, $author$project$Route$Posts, $elm$url$Url$Parser$top),
			A2(
...
var $author$project$Post$postAuthorEncoder = F2(
	function (authorName, authorUrl) {
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'url',
					$elm$json$Json$Encode$string(authorUrl))
				]));
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'author',
				A2($author$project$Post$postAuthorEncoder, post.authorName, post.authorUrl))
			]));
};
...
var $author$project$Ports$storePosts = _Platform_outgoingPort('storePosts', $elm$json$Json$Encode$string);
var $author$project$Post$savePosts = function (posts) {
	return $author$project$Ports$storePosts(
		A2(
			$elm$json$Json$Encode$encode,
			0,
			A2($elm$json$Json$Encode$list, $author$project$Post$postEncoder, posts)));
};
var $author$project$Page$ListPosts$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'PostsReceived':
				var response = msg.a;
				var savePostsCmd = function () {
					if (response.$ === 'Success') {
						var actualPosts = response.a;
						return $author$project$Post$savePosts(actualPosts);
					} else {
						return $elm$core$Platform$Cmd$none;
					}
				}();
...
var $author$project$Page$NewPost$PostCreated = function (a) {
	return {$: 'PostCreated', a: a};
};
var $author$project$Post$newPostEncoder = function (post) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$Page$NewPost$createPost = function (post) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$jsonBody(
				$author$project$Post$newPostEncoder(post)),
			expect: A2($elm$http$Http$expectJson, $author$project$Page$NewPost$PostCreated, $author$project$Post$postDecoder),
			url: 'http://localhost:5019/posts'
		});
};
	...
	function (msg, model) {
		switch (msg.$) {
			case 'StoreTitle':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{post: updateTitle}),
					$elm$core$Platform$Cmd$none);
			case 'StoreAuthorName':
				var name = msg.a;
				var oldPost = model.post;
				var updateAuthorName = _Utils_update(
					oldPost,
					{authorName: name});
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'StoreAuthorUrl':
				var url = msg.a;
				var oldPost = model.post;
				var updateAuthorUrl = _Utils_update(
					oldPost,
					{authorUrl: url});
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'CreatePost':
				return _Utils_Tuple2(
					model,
					$author$project$Page$NewPost$createPost(model.post));
			default:
				if (msg.a.$ === 'Ok') {
					return _Utils_Tuple2(
						model,
			...
			switch (_v0.a.$) {
					...
					if (_v0.b.$ === 'ListPage') {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									page: $author$project$Main$ListPage(updatedModel)
								}),
				...
				case 'EditPageMsg':
					if (_v0.b.$ === 'EditPage') {
						var subMsg = _v0.a.a;
						var pageModel = _v0.b.a;
						var _v2 = A2($author$project$Page$EditPost$update, subMsg, pageModel);
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									page: $author$project$Main$EditPage(updatedModel)
								}),
				...
				case 'NewPageMsg':
					if (_v0.b.$ === 'NewPage') {
						var subMsg = _v0.a.a;
						var pageModel = _v0.b.a;
						var _v3 = A2($author$project$Page$NewPost$update, subMsg, pageModel);
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									page: $author$project$Main$NewPage(updatedModel)
								}),
...
var $author$project$Page$ListPosts$Delete = function (a) {
	return {$: 'Delete', a: a};
};
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Page$ListPosts$Delete(post.id))
							]),
						_List_fromArray(
							[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Create new post')
					])),
				$author$project$Page$ListPosts$viewPosts(model.posts),
				$author$project$Page$ListPosts$viewDeleteError(model.deleteError)
			]));
};
var $author$project$Page$NewPost$CreatePost = {$: 'CreatePost'};
var $author$project$Page$NewPost$StoreAuthorName = function (a) {
	return {$: 'StoreAuthorName', a: a};
};
var $author$project$Page$NewPost$StoreAuthorUrl = function (a) {
	return {$: 'StoreAuthorUrl', a: a};
};
var $author$project$Page$NewPost$StoreTitle = function (a) {
	return {$: 'StoreTitle', a: a};
};
var $author$project$Page$NewPost$newPostForm = A2(
	$elm$html$Html$form,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$type_('text'),
							$elm$html$Html$Events$onInput($author$project$Page$NewPost$StoreTitle)
						]),
					_List_Nil)
				])),
			A2($elm$html$Html$br, _List_Nil, _List_Nil),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$type_('text'),
							$elm$html$Html$Events$onInput($author$project$Page$NewPost$StoreAuthorName)
						]),
					_List_Nil)
				])),
			A2($elm$html$Html$br, _List_Nil, _List_Nil),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$type_('text'),
							$elm$html$Html$Events$onInput($author$project$Page$NewPost$StoreAuthorUrl)
						]),
					_List_Nil)
				])),
			A2($elm$html$Html$br, _List_Nil, _List_Nil),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$type_('button'),
							$elm$html$Html$Events$onClick($author$project$Page$NewPost$CreatePost)
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Submit')
...
var $author$project$Page$NewPost$viewError = function (maybeError) {
	if (maybeError.$ === 'Just') {
		var error = maybeError.a;
		return A2(
			$elm$html$Html$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Couldn\'t create a post at this time.')
						])),
					$elm$html$Html$text('Error: ' + error)
				]));
	} else {
...
var $author$project$Page$NewPost$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				$author$project$Page$NewPost$newPostForm,
				$author$project$Page$NewPost$viewError(model.createError)
			]));
};
	...
	switch (_v0.$) {
		...
		default:
			...
			return A2(
				...
				$author$project$Page$NewPost$view(pageModel));
	}
};
